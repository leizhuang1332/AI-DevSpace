...
// ============================================================================
// activeSourceRef / onSourceRefClick 接口位
//   - ticket 03 接入,本期(ticket 07 之前)保留接口位
//   - ticket 07 · ADR-0018 D3:onSourceRefClick 实际接入 → <mark> click 触发回调
// ============================================================================

describe('DocumentReaderPane · activeSourceRef / onSourceRefClick 接口位 + 反向联动', () => {
  ...
  it('ticket 07:click <mark> → onSourceRefClick 被调一次,传对应 SourceRef', () => {
  ...
  it('ticket 07:多引用同一 span → click 取该 span 对应的第一条 ref', () => {
    const onClick = vi.fn()
    render(
      <DocumentReaderPane
        prdMarkdown={PRD_5LINE}
  ...
  it('ticket 07:click 非 mark 区域(如段落)→ onSourceRefClick 不被调', () => {
    const onClick = vi.fn()
    render(
      <DocumentReaderPane
        prdMarkdown={PRD_5LINE}
